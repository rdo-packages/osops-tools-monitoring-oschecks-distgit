...
%prep
#%autosetup -n osops-tools-monitoring-%{upstream_version}/monitoring-for-openstack -S git
%setup -q -n osops-tools-monitoring-%{upstream_version}/monitoring-for-openstack
